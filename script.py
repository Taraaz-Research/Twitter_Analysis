...
for tweet in tweepy.Cursor(api.search,q=str.lower(a), count=1000,
    ...
    csvWriter.writerow([tweet.user.screen_name, tweet.user.location, tweet.lang, tweet.text.encode('utf-8'), tweet.created_at, tweet.retweet_count, tweet.favorite_count])
